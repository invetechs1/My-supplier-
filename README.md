...
Docs: [API contract](docs/API.md) · [Architecture](docs/ARCHITECTURE.md) · [Roadmap](docs/ROADMAP.md) · [Developer handover](docs/DEVELOPER-HANDOVER.md) · [Launch plan (Arabic)](docs/LAUNCH-PLAN-AR.pdf) · **[Go-live runbook](deploy/GO-LIVE.md)**
...
* **Price discovery** – search 1,305 seeded products across 62 categories covering construction, maintenance and operations (materials, equipment and machinery, MRO spares, HVAC, pumps and motors, valves, lubricants, cleaning, security and networking, irrigation, fire safety, furniture, rental by the day, services by the job,
