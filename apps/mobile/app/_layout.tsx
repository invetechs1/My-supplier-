...
// Uncaught errors and unhandled rejections are POSTed to /client-errors (throttled, never throws).
            ...
            <CartProvider>
              ...
              <AppErrorBoundary>
                ...
                >
                  ...
                  <Stack.Screen name="supplier/products" options={{ title: "My products" }} />
