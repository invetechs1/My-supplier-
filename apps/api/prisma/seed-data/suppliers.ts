...
export const supplierCategoryExtensions: Record<string, string[]> = {
  ...
  "Gulf Electrical Supplies": ["security-cctv", "low-current-networking", "industrial-electrical-automation", "generator-ups-spares", "smart-building-bms", "solar-energy"],
  ...
  "Jubail Industrial Supplies": ["lubricants-chemicals", "glass-aluminium-systems", "valves-fittings-flanges", "hoses-seals-gaskets", "industrial-electrical-automation", "roofing-cladding"],
