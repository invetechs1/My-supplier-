...
<body><div class="noprint" style="text-align:right;margin-bottom:12px"><button id="print" style="background:#0B6E4F;color:#fff;border:0;border-radius:8px;padding:10px 16px;font-weight:600;cursor:pointer">Print / Save as PDF</button></div>
