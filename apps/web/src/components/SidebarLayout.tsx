...
const I = {
  ...
  repeat: <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />,
...
export const buyerNav: NavItem[] = [
  ...
  { href: "/dashboard/orders", labelKey: "dash.orders", icon: <Icon>{I.box}</Icon>, group: "dash.group.buy" },
  { href: "/dashboard/buy-again", labelKey: "dash.buyAgain", icon: <Icon>{I.repeat}</Icon>, group: "dash.group.buy" },
  { href: "/dashboard/lists", labelKey: "dash.lists", icon: <Icon>{I.heart}</Icon>, group: "dash.group.buy" },
  { href: "/dashboard/recurring", labelKey: "dash.recurring", icon: <Icon>{I.clock}</Icon>, group: "dash.group.buy" },
  { href: "/dashboard/alerts", labelKey: "dash.alerts", icon: <Icon>{I.bolt}</Icon>, group: "dash.group.buy" },
  { href: "/dashboard/returns", labelKey: "dash.returns", icon: <Icon>{I.undo}</Icon>, group: "dash.group.buy" },
  { href: "/dashboard/rfqs", labelKey: "dash.rfqs", icon: <Icon>{I.doc}</Icon>, group: "dash.group.rfq" },
  { href: "/dashboard/rfqs/new", labelKey: "dash.newRfq", exact: true, icon: <Icon>{I.plus}</Icon>, group: "dash.group.rfq" },
  { href: "/dashboard/quotations", labelKey: "dash.quotations", icon: <Icon>{I.receipt}</Icon>, badge: "AI", group: "dash.group.rfq" },
  { href: "/dashboard/addresses", labelKey: "dash.addresses", icon: <Icon>{I.pin}</Icon>, group: "dash.group.account" },
  { href: "/dashboard/integrations", labelKey: "dash.integrations", icon: <Icon>{I.link}</Icon>, group: "dash.group.account" },
  { href: "/dashboard/notifications", labelKey: "dash.notifications", icon: <Icon>{I.bell}</Icon>, group: "dash.group.account" },
  { href: "/account", labelKey: "nav.account", icon: <Icon>{I.user}</Icon>, group: "dash.group.account" },
];
...
export const supplierNav: NavItem[] = [
  ...
  { href: "/supplier/integrations", labelKey: "sup.integrations", icon: <Icon>{I.link}</Icon>, group: "sup.group.company", area: "company" },
...
export const adminNav: NavItem[] = [
  ...
  { href: "/admin/credit", labelKey: "admin.credit", icon: <Icon>{I.card}</Icon>, group: "admin.group.partners" },
