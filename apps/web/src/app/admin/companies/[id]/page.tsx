...
import { api, errorMessage, fileUrl, type AdminCompanyDetail } from "@/lib/api";
    ...
    <li className="grid gap-3 px-5 py-4 md:grid-cols-[1fr_auto]">
      <div className="min-w-0">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <a href={fileUrl(doc.fileUrl) ?? "#"} target="_blank" rel="noreferrer" className="truncate text-sm font-medium text-brand-700 hover:underline" dir="ltr">{doc.fileName}</a>
